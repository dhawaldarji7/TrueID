                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                           ...
                           // Toast.makeText(Reports.this, obj.getString("message"), Toast.LENGTH_SHORT).show();
                            ...
                            if(cnt==0)
                                    Toast.makeText(getApplicationContext(),"No Reports to fetch",Toast.LENGTH_LONG).show();
                            else
                                Toast.makeText(getApplicationContext(),"Reports fetched successfully",Toast.LENGTH_LONG).show();
