...
public class AddRto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(Html.fromHtml("<h2><font color='#ffffff'>Add a new RTO official</font></h2>"));
    ...
    private class addUser extends AsyncTask<String, Void, String>
    {
        ...
        protected void onPostExecute(String s) {
            ...
            {
                Toast.makeText(context, "Can't Register.UserId Already Exists", Toast.LENGTH_SHORT).show();
            }
