...
public class AddDoctor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(Html.fromHtml("<h2><font color='#ffffff'>Add a new Doctor</font></h2>"));
    ...
    private class addUser extends AsyncTask<String, Void, String>
    {
        ...
        protected String doInBackground(String... params)
        {
            ...
            HttpPost post=new HttpPost(url.url+"/addDoctor.php");
            //temp=params[0];
        ...
        protected void onPostExecute(String s) {
            ...
            {
                Toast.makeText(context, "Can't Register.User Already Exists", Toast.LENGTH_SHORT).show();
            }
