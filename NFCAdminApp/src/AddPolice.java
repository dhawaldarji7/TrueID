...
public class AddPolice extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(Html.fromHtml("<h2><font color='#ffffff'>Add a new Police official</font></h2>"));
    ...
    private class addUser extends AsyncTask<String, Void, String>
    {
        ...
        protected String doInBackground(String... params)
        {
            ...
            HttpPost post=new HttpPost(url.url+"/addPolice.php");
            //temp=params[0];
        ...
        protected void onPostExecute(String s) {
            ...
            {
                Toast.makeText(context, "Can't Add.User Already Exists", Toast.LENGTH_SHORT).show();
            }
