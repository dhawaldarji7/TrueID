...
public static String str="";
    ...
    public static final String UPLOAD_URL = url.url+"/uploadpolice.php";
    public static final String PDF_FETCH_URL = url.url+"/getPdfspolice.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     tv=(TextView)findViewById(R.id.uname);
      //tv.setText("Name:"+DoctorScanActivity.receivedValue);
    ...
    private class getAll extends AsyncTask<String, Void, String>
    {
        ...
        protected void onPostExecute(String s) {
           ...
           // Toast.makeText(context, receivedValue, Toast.LENGTH_SHORT).show();
            tv.setText("Suspect Name:"+receivedValue);
